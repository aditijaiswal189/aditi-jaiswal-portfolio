function MySkills() {
  return <section className="bg-stone-100 pb-[60px]">
    <h3 className="text-xl  font-bold p-6 md:text-2xl md:font-semibold md:p-8 lg:text-3xl lg:font-bold ">My Skills!</h3>
    <div className="p-6 grid grid-cols-5 gap-3  md:p-8 md:grid-cols-6 md:gap-5 xs:grid-cols-4 lg:grid-cols-4">
      ...
      <button className="bg-stone-300 py-3 px-5 rounded-md text-xs font-semibold text-stone-700 tracking-wider  md:py-4 md:px-6 md:text-sm  md:tracking-widest ">GitHub</button>
      <button className="bg-stone-300 py-3 px-5 rounded-md text-xs font-semibold text-stone-700 col-span-2 tracking-wider  md:py-4 md:px-6 md:text-sm  md:tracking-widest ">Styled Components</button>
      <button className="bg-stone-300 py-3 px-5 rounded-md text-xs font-semibold text-stone-700 tracking-wider  md:py-4 md:px-6 md:text-sm  md:tracking-widest ">Redux</button>
      <button className="bg-stone-300 py-3 px-5 rounded-md text-xs font-semibold text-stone-700 col-span-2 tracking-wider  md:py-4 md:px-6 md:text-sm  md:tracking-widest ">Responsive Design</button>
    </div>
  </section>;
}
