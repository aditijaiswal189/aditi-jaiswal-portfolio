...
function About() {
  return <section className="bg-hero-pattern " id="about" >
   ...
   <div className="flex flex-col justify-center relative">
    <div className="bg-gray-50 p-2 absolute  left-3 top-7 lg:p-4 lg:left-6 lg:top-9 2xl:p-6 2xl:left-8 2xl:top-11">
    ...
    <p className="text-center  text-2xl  font-semibold p-5 max-w-[80%] mx-auto lg:max-w-[60%] ">A focused Frontend Web Developer building the Frontend of Web Applications and Websites. </p>
